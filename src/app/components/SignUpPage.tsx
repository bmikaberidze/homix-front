...
export default function SignUpPage({ onNavigate, onSuccess, preSelectedPlan }: SignUpPageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      // If there's a pre-selected plan, go to onboarding, otherwise go home
      if (preSelectedPlan) {
